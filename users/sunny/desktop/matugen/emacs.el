;;; matugen-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme matugen "Theme using Template variables with quality of life improvements.")
