...
}:
{
  ...
  pcsx2 = {
    ...
    version = "v2.7.243";
    src = fetchurl {
      url = "https://github.com/PCSX2/pcsx2/releases/download/v2.7.243/pcsx2-v2.7.243-linux-appimage-x64-Qt.AppImage";
      sha256 = "sha256-DY45V82/W8o58UlfszXC3dVOpL0LaH3jAmZulurfEpE=";
    };
  };
}
