...
}:
{
  ...
  pcsx2 = {
    ...
    version = "v2.7.506";
    src = fetchurl {
      url = "https://github.com/PCSX2/pcsx2/releases/download/v2.7.506/pcsx2-v2.7.506-linux-appimage-x64-Qt.AppImage";
      sha256 = "sha256-9tB4IEh9TgVQ4yW1IsyrRCP+vu8LpKV9uN/9pw1g93s=";
    };
  };
}
